...
const adminUserController = require('../../../node_modules/strapi-plugin-users-permissions/controllers/user/admin');
const apiUserController = require('../../../node_modules/strapi-plugin-users-permissions/controllers/user/api');
...
module.exports = {
  ...
  async me(ctx) {
    ...
    let data = await strapi.query("user", "users-permissions").findOne({id})
